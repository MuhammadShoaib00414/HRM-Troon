                    ...
                    <div class="editor-content">
                        <div class="preview-main client-preview">
                            <div data-v-e23d9750="" class="d"
                                style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                                    ...
                                    <div data-v-e23d9750="" class="d-table">
                                        <div data-v-e23d9750="" class="d-table">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-tr"
                                                ...
                                                <div class="d-table-th w-4 text-right">{{ __('Price') }}<br><small
                                                ...
                                                @if (isset($invoice->itemData) && count($invoice->itemData) > 0)
                                                    @foreach ($invoice->itemData as $key => $item)
                                                        ...
                                                        <div class="d-table-tr"
                                                            ...
                                                            <div class="d-table-td w-3">
                                                                <pre
                                                                    data-v-f2a183a6="">{{ !empty($item->description) ? $item->description : '-' }}</pre>
                                                            </div>
