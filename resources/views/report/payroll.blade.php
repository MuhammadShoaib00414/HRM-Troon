...
@section('content')
    ...
    <div id="printableArea" class="mt-4">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h5 class="report-text gray-text mb-0">{{__('Provident Funds')}} :</h5>
                    <h5 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totalprovidentPayment'])}}</h5>
                </div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h5 class="report-text gray-text mb-0">{{__('Tax Dedutcion')}} :</h5>
                    <h5 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totaltaxPayment'])}}</h5>
                </div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h5 class="report-text gray-text mb-0">{{__('EOBI Amount')}} :</h5>
                    <h5 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totaleobiPayment'])}}</h5>
                </div>
            </div>
