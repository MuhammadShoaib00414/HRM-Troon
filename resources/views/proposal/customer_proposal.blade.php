...
<head>
  ...
  <title>{{(Utility::companyData($proposal->created_by,'title_text')) ? Utility::companyData($proposal->created_by,'title_text') : config('app.name', 'AccountGo')}} - {{__('Proposal')}}</title>
                                    ...
                                    <div class="table-responsive mt-2">
                                        <table class="table mb-0 table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">{{$user->priceFormat($proposal->getSubTotal())}}</td>
                                            </tr>
                                            @if($proposal->discount_apply==1)
                                                <tr>
                                                    <td colspan="6"></td>
                                                    <td class="text-right"><b>{{__('Discount')}}</b></td>
                                                    <td class="text-right">{{$user->priceFormat($proposal->getTotalDiscount())}}</td>
                                                </tr>
                                            @endif
                                            @if(!empty($taxesData))
                                            ...
                                            <tr>
                                                ...
                                                <td class="blue-text text-right">{{$user->priceFormat($proposal->getTotal())}}</td>
                                            </tr>
                                            </tfoot>
                                        </table>
                                    </div>
