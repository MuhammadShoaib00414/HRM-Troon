                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0 dataTable">
                            ...
                            @foreach ($getAllemployeeAttandanceData as $att)
                                ...
                                <tr>
                                    <td>{{ $att['user_id'] }}</td>
                                    <td><?php echo(isset($getUser[$att['user_id']]) ? $getUser[$att['user_id']]['name'] : $att['user_id']); ?></td>
                                    <td>{{ \Auth::user()->dateFormat($att['date']) }}</td>
                                    <td>{{ $att['status'] }}</td>
                                    <td>{{ ($att['check_in'] !='00:00:00') ?\Auth::user()->timeFormat($att['check_in']):'00:00' }} </td>
                                    <td>{{ $att['type'] }}</td>
                                    <td>{{ $att['late'] }}</td>
                                    <td>{{ $att['early_leaving'] }}</td>
                                    <td>{{ $att['overtime'] }}</td>
