            ...
            @if(\Auth::user()->type != 'client')
                <ul class="navbar-nav navbar-nav-docs">
                    @if( Gate::check('show hrm dashboard') || Gate::check('show project dashboard') || Gate::check('show account dashboard'))
                        <li class="nav-item">
                            <a class="nav-link {{ (Request::segment(1) == 'account-dashboard' || Request::segment(1) == 'project-dashboard' || Request::segment(1) == 'hrm-dashboard')?' active':'collapsed'}}"
                               href="#navbar-dashboard" data-toggle="collapse" role="button"
                               aria-expanded="{{ (Request::segment(1) == 'account-dashboard' || Request::segment(1) == 'project-dashboard' || Request::segment(1) == 'hrm-dashboard')?'true':'false'}}"
                               aria-controls="navbar-dashboard">
                                <i class="fa fa-fire"></i>{{__('Dashboard')}}
                                <i class="fas fa-sort-up"></i>
                            </a>
                            <div class="collapse {{ (Request::segment(1) == 'account-dashboard' || Request::segment(1) == 'project-dashboard' || Request::segment(1) == 'hrm-dashboard')?'show':''}}"
                                 id="navbar-dashboard">
                                        ...
                                        @can('show hrm dashboard')
                                            <li class="nav-item {{ (Request::route()->getName() == 'hrm.dashboard') ? ' active' : '' }}">
                                                <a href="{{route('hrm.dashboard')}}"
                                                   class="nav-link">{{ __("HRM Dashboard") }}</a>
                                            </li>
                                        @endcan
                                    @endif
                                        ...
                                        @can('show account dashboard')
                                            <li class="nav-item {{ (Request::route()->getName() == 'dashboard') ? ' active' : '' }}">
                                                <a href="{{route('dashboard')}}"
                                                   class="nav-link">{{ __("Account Dashboard") }}</a>
                                            </li>
                                        @endif
                                    @endif
                                        ...
                                        @can('show project dashboard')
                                            <li class="nav-item {{ (Request::route()->getName() == 'project.dashboard') ? ' active' : '' }}">
                                                <a href="{{route('project.dashboard')}}"
                                                   class="nav-link">{{ __("Project Dashboard") }}</a>
                                            </li>
                                        @endcan
                                    @endif
                    ...
                    @can('manage customer proposal')
                        <li class="nav-item">
                            <a href="{{route('customer.proposal')}}"
                               class="nav-link {{ (Request::route()->getName() == 'customer.proposal' || Request::route()->getName() == 'customer.proposal.show') ? ' active' : '' }}">
                    ...
                    @can('manage customer invoice')
                        <li class="nav-item">
                            <a href="{{route('customer.invoice')}}"
                               class="nav-link {{ (Request::route()->getName() == 'customer.invoice' || Request::route()->getName() == 'customer.invoice.show') ? ' active' : '' }} ">
                    ...
                    @can('manage customer payment')
                        <li class="nav-item">
                            <a href="{{route('customer.payment')}}"
                               class="nav-link {{ (Request::route()->getName() == 'customer.payment') ? ' active' : '' }} ">
                    ...
                    @can('manage customer transaction')
                        <li class="nav-item">
                            <a href="{{route('customer.transaction')}}"
                               class="nav-link {{ (Request::route()->getName() == 'customer.transaction') ? ' active' : '' }}">
                    ...
                    @can('manage vender bill')
                        <li class="nav-item">
                            <a href="{{route('vender.bill')}}"
                               class="nav-link {{ (Request::route()->getName() == 'vender.bill' || Request::route()->getName() == 'vender.bill.show') ? ' active' : '' }} ">
                    ...
                    @can('manage vender payment')
                        <li class="nav-item">
                            <a href="{{route('vender.payment')}}"
                               class="nav-link {{ (Request::route()->getName() == 'vender.payment') ? ' active' : '' }} ">
                                <i class="fas fa-money-bill-alt"></i>{{__('Payment')}}
                            </a>
                        </li>
                    @endcan
                    @can('manage vender transaction')
                        <li class="nav-item">
                            <a href="{{route('vender.transaction')}}"
                               class="nav-link {{ (Request::route()->getName() == 'vender.transaction') ? ' active' : '' }}">
                                <i class="fas fa-history"></i>{{__('Transaction')}}
                            </a>
                        </li>
                    @endcan
                <!-- For Hrm -->
                                ...
                                <ul class="nav flex-column">
                                    <ul class="nav flex-column">
                                        <li class="nav-item submenu-li ">
                                            <a class="nav-link {{ (Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'reports-payroll') ? 'active' : 'collapsed'}}"
                                            ...
                                            <div class="submenu-ul collapse{{ (Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'reports-payroll') ? 'show' : ''}}"
                                                 id="hr-report" style="">
                                                <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <div class="collapse show" id="provident-report-navbar" style="">
                                <ul class="nav flex-column">
                                    <ul class="nav flex-column">
                                        <li class="nav-item submenu-li ">
                                            <a class="nav-link {{ (Request::segment(1) == 'report-provident-fund' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'reports-payroll') ? 'active' : 'collapsed'}}"
                                               href="#provident-report" data-toggle="collapse" role="button"
                                               aria-expanded="{{(Request::segment(1) == 'report-provident-fund'
                                            ...
                                            <div class="submenu-ul collapse{{ (Request::segment(1) == 'report-provident-fund' ||
                                                         Request::segment(1) == 'request-provident') ? 'show' : ''}}"
                                                 id="provident-report" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item {{ request()->is('report-provident-fund') ? 'active' : '' }}">
                                                        <a class="nav-link"
                                                           href="{{ url('report-provident-fund') }}"> {{__('PF Status')}}</a>
                                                    </li>

                                                    <li class="nav-item {{ request()->is('request-provident') ? 'active' : '' }}">
                                                        <a class="nav-link"
                                                           href="{{ url('request-provident') }}">{{__('PF withdrawal')}}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                        ...
                        <li class="nav-item">
                            <div class="collapse show" id="opd-payment-navbar" style="">
                                <ul class="nav flex-column">
                                    <ul class="nav flex-column">
                                        <li class="nav-item submenu-li ">
                                            <a class="nav-link {{ (Request::segment(1) == 'opd-payment' || Request::segment(1) == 'allocated-amount' || Request::segment(1) == 'opd-payment-status') ? 'active' : 'collapsed'}}"
                                               href="#opd-payment" data-toggle="collapse" role="button"
                                               aria-expanded="{{(Request::segment(1) == 'opd-payment'
                                            ...
                                            <div class="submenu-ul collapse{{ (Request::segment(1) == 'opd-payment' ||
                                                         Request::segment(1) == 'allocated-amount' || Request::segment(1) == 'opd-payment-status') ? 'show' : ''}}"
                                                 id="opd-payment" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item {{ request()->is('allocated-amount') ? 'active' : '' }}">
                                                        <a class="nav-link"
                                                           href="{{ url('allocated-amount') }}"> {{__('Allocated amount')}}</a>
                                                    </li>
                                                    <li class="nav-item {{ request()->is('opd-payment') ? 'active' : '' }}">
                                                        <a class="nav-link"
                                                           href="{{ url('opd-payment') }}"> {{__('OPD Payment')}}</a>
                                                    </li>
                                                    <li class="nav-item {{ request()->is('opd-payment-status') ? 'active' : '' }}">
                                                        <a class="nav-link"
                                                           href="{{ url('opd-payment-status') }}">{{__('OPD Payment Status')}}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                            ...
                            <li class="nav-item">
                                <div class="collapse show" id="employee-eobi-navbar" style="">
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li ">
                                                <a class="nav-link {{ (Request::segment(1) == 'employee-eobi' || Request::segment(1) == 'employee-eobi-status') ? 'active' : 'collapsed'}}"
                                                   href="#employee-eobi" data-toggle="collapse" role="button"
                                                   aria-expanded="{{(Request::segment(1) == 'employee-eobi'
                                                ...
                                                <div class="submenu-ul collapse{{ (Request::segment(1) == 'employee-eobi' ||
                                                         Request::segment(1) == 'employee-eobi-status') ? 'show' : ''}}"
                                                     id="employee-eobi" style="">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item {{ request()->is('employee-eobi') ? 'active' : '' }}">
                                                            <a class="nav-link"
                                                               href="{{ url('employee-eobi') }}"> {{__('Employee EOBI')}}</a>
                                                        </li>


                                                        <li class="nav-item {{ request()->is('employee-eobi-status') ? 'active' : '' }}">
                                                            <a class="nav-link"
                                                               href="{{ url('employee-eobi-status') }}">{{__('Employee EOBI Status')}}</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </li>
                    ...
                    @can('manage report')
                        <li class="nav-item">
                            <a href="{{ url('employee-tax') }}"
                               class="nav-link {{ (Request::segment(1) == 'employee-tax')?'active':''}}">
                                <i class="fas fa-user-circle"></i>{{__('Employee Tax')}}
                            </a>
                        </li>
                    @endcan
                    @if(\Auth::user()->show_hrm() == 1)
                        @if( Gate::check('manage employee') || Gate::check('manage setsalary'))
                            <li class="nav-item">
                                <a class="nav-link {{ (Request::segment(1) == 'holiday-calender' || Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'reports-payroll' || Request::segment(1) == 'leavetype' || Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee' || Request::segment(1) == 'document-upload' || Request::segment(1) == 'document' || Request::segment(1) == 'performanceType'  ||
                                   ...
                                   aria-expanded="{{ (Request::segment(1) == 'holiday-calender' || Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'performanceType' || Request::segment(1) == 'reports-payroll' || Request::segment(1) == 'leavetype' || Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee' || Request::segment(1) == 'document-upload' || Request::segment(1) == 'document' ||
                                ...
                                <div
                                        class="collapse show {{ (Request::segment(1) == 'holiday-calender' || Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'performanceType' || Request::segment(1) == 'reports-payroll' || Request::segment(1) == 'leavetype' || Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee' || Request::segment(1) == 'document-upload' || Request::segment(1) == 'document' || Request::segment(1) == 'branch' ||
                                    ...
                                    <ul class="nav flex-column">
                                                    ...
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item  {{ (Request::segment(1) == 'employee' ? 'active' : '')}}">
                                                            @if(\Auth::user()->type =='Employee')
                                                                ...
                                                                @endphp
                                                                <a href="{{route('employee.show',\Illuminate\Support\Facades\Crypt::encrypt(\Auth::user()->id))}}"
                                                        ...
                                                        <li class="nav-item submenu-li ">
                                                            <a class="nav-link {{ (Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip-list'  || Request::segment(1) == 'payslip') ? 'active' : 'collapsed'}}"
                                                               href="#navbar-accounting8-users" data-toggle="collapse"
                                                               role="button"
                                                               aria-expanded="{{ (Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip') ? 'true' : 'false'}}"
                                                               aria-controls="navbar-getting-started1">
                                                                {{__('Payroll')}}
                                                                <i class="fas fa-sort-up"></i>
                                                            </a>
                                                            <div class="submenu-ul {{ (Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip' || Request::segment(1) == 'payslip-list') ? 'show' : 'collapse'}}"
                                                                 id="navbar-accounting8-users" style="">
                                                                <ul class="nav flex-column">
                                                                    @can('manage pay slip')
                                                                        <li class="nav-item {{ (request()->is('payslip') ? 'active' : '')}}">
                                                                            <a href="{{route('payslip.index')}}"
                                                                               class="nav-link">{{__('Payslip')}}</a>
                                                                        </li>
                                                                    @endcan
                                                                    @can('manage set salary')
                                                                        <li class="nav-item {{ (request()->is('setsalary') ? 'active' : '')}}">
                                                                            <a href="{{route('setsalary.index')}}"
                                                                               class="nav-link">{{__('Set salary')}}</a>
                                                                        </li>
                                                                    @endcan

                                                                    @can('manage pay slip')
                                                                        <li class="nav-item {{ (request()->is('payslip-list') ? 'active' : '')}}">
                                                                            <a href="{{url('payslip-list')}}"
                                                                               class="nav-link">{{__('Payslip List')}}</a>
                                                                        </li>
                                                                    @endcan
                                                                </ul>
                                                            </div>
                                        ...
                                        <li class="nav-item">
                                            <div class="collapse show" id="navbar-hr" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item submenu-li ">
                                                        <a class="nav-link {{ (Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee') ? 'active' :'collapsed'}}"
                                                           href="#navbar-hr-leave_management" data-toggle="collapse"
                                                           role="button"
                                                           aria-expanded="{{ (Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee') ? 'true' :'false'}}"
                                                           aria-controls="navbar-getting-started1">
                                                            {{__('Leave Management')}}
                                                            <i class="fas fa-sort-up"></i>
                                                        </a>
                                                        <div class="submenu-ul {{ (Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee') ? 'show' :'collapse'}}"
                                                             id="navbar-hr-leave_management" style="">
                                                            <ul class="nav flex-column">
                                                                @can('manage leave')
                                                                    <li class="nav-item {{ (Request::route()->getName() == 'leave.index') ?'active' :''}}">
                                                                        <a href="{{route('leave.index')}}"
                                                                           class="nav-link">{{__('Manage Leave')}}</a>
                                                                    </li>
                                                                @endcan
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <div class="collapse show"
                                                                            ...
                                                                            <ul class="nav flex-column">
                                                                                <ul class="nav flex-column">
                                                                                    <li class="nav-item submenu-li ">
                                                                                        <a class="nav-link {{ (Request::segment(1) == 'attendanceemployee') ? 'active' : 'collapsed'}}"
                                                                                        ...
                                                                                        <div class="submenu-ul {{ (Request::segment(1) == 'attendanceemployee') ? 'show' : 'collapse'}}"
                                                                                            ...
                                                                                            <ul class="nav flex-column">
                                                                                                <li class="nav-item {{ (Request::route()->getName() == 'attendanceemployee.index' ? 'active' : '')}}">
                                                                                                    <a href="{{route('attendanceemployee.index')}}"
                                                                                                       class="nav-link">{{__('Marked Attendance')}}</a>
                                                                                                </li>
                                                                                                @can('create attendance')
                                                                                                    <li class="nav-item {{ (Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'active' : '')}}">
                                                                                                        <a href="{{ route('attendanceemployee.bulkattendance') }}"
                                                                                                           class="nav-link">{{__('Bulk Attendance')}}</a>
                                                                                                    </li>
                                                                                                @endcan
                                                                                            </ul>
                                                                                        </div>
                                        ...
                                        <li class="nav-item">
                                            <div class="collapse show" id="performance-navbar" style="">
                                                <ul class="nav flex-column">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item submenu-li ">
                                                            <a class="nav-link {{ (Request::segment(1) == 'indicator' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'goaltracking') ? 'active' : 'collapsed'}}"
                                        ...
                                        <li class="nav-item">
                                            <div class="collapse show" id="training-navbar" style="">
                                                <ul class="nav flex-column">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item submenu-li ">
                                                            <a class="nav-link {{ (Request::segment(1) == 'trainer' || Request::segment(1) == 'training') ? 'active' : 'collapsed'}}"
                                                            ...
                                                            <div class="submenu-ul {{ (Request::segment(1) == 'trainer' || Request::segment(1) == 'training') ? 'show' : 'collapse'}}"
                                                                 id="navbar-training" style="">
                                                                <ul class="nav flex-column">
                                                                    @can('manage training')
                                                                        <li class="nav-item {{ (request()->is('training*') ? 'active' : '')}}">
                                                                            <a href="{{route('training.index')}}"
                                                                               class="nav-link">{{__('Training List')}}</a>
                                                                        </li>
                                                                    @endcan
                                                                    @can('manage trainer')
                                                                        <li class="nav-item {{ (request()->is('trainer*') ? 'active' : '')}}">
                                                                            <a href="{{route('trainer.index')}}"
                                                                               class="nav-link">{{__('Trainer')}}</a>
                                                                        </li>
                                                                    @endcan
                                                                </ul>
                                                            </div>
                                        ...
                                        <li class="nav-item">
                                            <div class="collapse show" id="recruitment-navbar" style="">
                                                <ul class="nav flex-column">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item submenu-li">
                                                            <a class="nav-link {{ (Request::segment(1) == 'job' || Request::segment(1) == 'job-application' || Request::segment(1) == 'candidates-job-applications' || Request::segment(1) == 'job-onboard' || Request::segment(1) == 'custom-question' || Request::segment(1) == 'interview-schedule' || Request::segment(1) == 'career') ? 'active' : 'collapsed'}}"
                                        ...
                                        <li class="nav-item">
                                            <div class="collapse show" id="hrmgo_constants" style="">
                                                <ul class="nav flex-column">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item submenu-li">
                                                            <a class="nav-link {{ (Request::segment(1) == 'leavetype' || Request::segment(1) == 'document' || Request::segment(1) == 'performanceType' || Request::segment(1) == 'branch' || Request::segment(1) == 'department' || Request::segment(1) == 'designation' || Request::segment(1) == 'job-stage'|| Request::segment(1) == 'performanceType'  || Request::segment(1) == 'job-category' || Request::segment(1) == 'terminationtype' ||
                                                               ...
                                                               role="button"
                                                               aria-expanded="{{ (Request::segment(1) == 'leavetype' || Request::segment(1) == 'document' || Request::segment(1) == 'performanceType' || Request::segment(1) == 'branch' || Request::segment(1) == 'department' || Request::segment(1) == 'designation' || Request::segment(1) == 'job-stage' || Request::segment(1) == 'performanceType' || Request::segment(1) == 'job-category' || Request::segment(1) == 'terminationtype' ||
                                                            ...
                                                            <div
                                                                    class="submenu-ul {{ (Request::segment(1) == 'leavetype' || Request::segment(1) == 'document' || Request::segment(1) == 'performanceType' || Request::segment(1) == 'branch' || Request::segment(1) == 'department' || Request::segment(1) == 'designation' || Request::segment(1) == 'job-stage' || Request::segment(1) == 'performanceType' || Request::segment(1) == 'job-category' || Request::segment(1) == 'terminationtype' ||
                ...
                <!-- end Hrm -->
                    ...
                    @else
                        @if( Gate::check('manage user') || Gate::check('manage role'))
                            <li class="nav-item">
                                <a class="nav-link {{ (Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients')?' active':'collapsed'}}"
                                   href="#navbar-staff" data-toggle="collapse" role="button"
                                   aria-expanded="{{ (Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients')?'true':'false'}}"
                                   aria-controls="navbar-staff">
                                    <i class="fa fa-users"></i>{{__('Staff')}}
                                    <i class="fas fa-sort-up"></i>
                                </a>
                                <div class="collapse {{ (Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients')?'show':''}}"
                                     id="navbar-staff">
                                    <ul class="nav flex-column">
                                        @can('manage user')
                        ...
                        @if(\Auth::user()->show_crm() == 1)
                            @if( Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder'))
                                <li class="nav-item">
                                    <a class="nav-link {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'pipelines' || Request::segment(1) == 'deals' || Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response')?' active':'collapsed'}}"
                                       href="#navbar-crm" data-toggle="collapse" role="button"
                                       aria-expanded="{{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'pipelines' || Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'deals' || Request::segment(1) == 'pipelines')?'true':'false'}}"
                                       aria-controls="navbar-crm">
                                        <i class="fa fa-filter"></i>{{__('CRM')}}
                                        <i class="fas fa-sort-up"></i>
                                    </a>
                                    <div class="collapse {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'deals' || Request::segment(1) == 'pipelines')?'show':''}}"
                                         id="navbar-crm">
                                        <ul class="nav flex-column">
                                            @can('manage lead')
                                            ...
                                            @can('manage form builder')
                                                <li class="nav-item {{ (Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response')?'active open':''}}">
                                                    <a href="{{route('form_builder.index')}}"
                                                       class="nav-link">{{__('Form Builder')}}</a>
                                                </li>
                                            @endcan
                                            @if(\Auth::user()->type=='company' || \Auth::user()->type=='client')
                                                <li class="nav-item">
                                                    <a href="{{route('contract.index')}}"
                                                       class="nav-link {{ (Request::segment(1) == 'contract')?'active':''}}">
                                                        {{__('Contract')}}
                                                    </a>
                                                </li>
                                            @endif
                                        ...
                                        <ul class="nav flex-column">
                                            ...
                                            @can('manage bug report')
                                                <li class="nav-item {{ (request()->is('bugs-report*') ? 'active' : '')}}">
                                                    <a href="{{route('bugs.view','list')}}"
                                                       class="nav-link">{{__('Bug')}}</a>
                                                </li>
                                            @endcan
                                            @can('manage project task')
                                                <li class="nav-item {{ (request()->is('calendar*') ? 'active' : '')}}">
                                                    <a href="{{ route('task.calendar',['all']) }}"
                                                       class="nav-link">{{__('Task Calender')}}</a>
                                                </li>
                                            @endcan
                                            @if(\Auth::user()->type!='super admin')
                                                <li class="nav-item {{ (Request::segment(1) == 'time-tracker')?'active open':''}}">
                                                    <a href="{{ route('time.tracker') }}"
                                                       class="nav-link">{{__('Tracker')}}</a>
                                                </li>
                                            @endif
                                                ...
                                                <li class="nav-item">
                                                    <div class="collapse show" id="taskgo_constants" style="">
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li">
                                                                    <a class="nav-link {{ (Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages') ? 'active' : 'collapsed'}}"
                                                                       href="#taskgo_navbar_constants"
                                                                       data-toggle="collapse" role="button"
                                                                       aria-expanded="{{ (Request::segment(1) == 'project-task-stages') ? 'true' : 'false'}}"
                                                                       aria-controls="navbar-getting-started1">
                                                                        {{__('Setup')}}
                                                                        <i class="fas fa-sort-up"></i>
                                                                    </a>
                                                                    <div class="submenu-ul {{ (Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages') ? 'show' : 'collapse'}}"
                            ...
                            @if( Gate::check('manage customer') || Gate::check('manage vender'))
                                <li class="nav-item">
                                    ...
                                    'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance' || Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')?' active':'collapsed'}}"
                                       ...
                                       aria-expanded="{{ (Request::segment(1) == 'customer' || Request::segment(1) == 'vender' || Request::segment(1) == 'proposal' || Request::segment(1) == 'budget'|| Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer' || Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type' || (Request::segment(1) == 'report' || Request::segment(1) == 'transaction') &&  Request::segment(2) != 'ledger' &&  Request::segment(2) != 'balance-sheet' &&  Request::segment(2) != 'trial-balance' || Request::segment(1) == 'goal' || Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance' || Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note' || Request::segment(1) == 'print-setting')?'true':'false'}}"
                                                ...
                                                <li class="nav-item">
                                                    <div class="collapse show" id="banking-navbar" style="">
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    <a class="nav-link {{(Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer')? 'active' :'collapsed'}}"
                                                                       href="#banking-nav" data-toggle="collapse"
                                                                       role="button"
                                                                       aria-expanded="{{(Request::segment(1) == 'bank-account' || Request::segment(1) == 'transfer')? 'true' :'false'}}"
                                                                       aria-controls="navbar-getting-started1">
                                                                        {{__('Banking')}}
                                                                        <i class="fas fa-sort-up"></i>
                                                                    </a>
                                                                    <div class="submenu-ul {{(Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer')? 'show' :'collapse'}}"
                                                            ...
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    <a class="nav-link {{(Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note')? 'active' :'collapsed'}}"
                                                                       ...
                                                                       role="button"
                                                                       aria-expanded="{{(Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note')? 'true' :'false'}}"
                                                                       aria-controls="navbar-getting-started1">
                                                                        {{__('Income')}}
                                                                        <i class="fas fa-sort-up"></i>
                                                                    </a>
                                                                    <div class="submenu-ul {{(Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note')? 'show' :'collapse'}}"
                                                                         id="income-nav" style="">
                                                                        <ul class="nav flex-column">
                                                                            @can('manage invoice')
                                                ...
                                                <li class="nav-item">
                                                    <div class="collapse show" id="expense-navbar" style="">
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    <a class="nav-link {{(Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')? 'active' :'collapsed'}}"
                                                                       href="#expense-nav" data-toggle="collapse"
                                                                       role="button"
                                                                       aria-expanded="{{(Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')? 'true' :'false'}}"
                                                                       aria-controls="navbar-getting-started1">
                                                                        {{__('Expense')}}
                                                                        <i class="fas fa-sort-up"></i>
                                                                    </a>
                                                                    <div class="submenu-ul {{(Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')? 'show' :'collapse'}}"
                                                ...
                                                <li class="nav-item">
                                                    <div class="collapse show" id="double-enrty-navbar" style="">
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    <a class="nav-link {{(Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')? 'active' :'collapsed'}}"
                                                                       href="#double-enrty-nav" data-toggle="collapse"
                                                                       role="button"
                                                                       aria-expanded="{{(Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')? 'true' :'false'}}"
                                                                       aria-controls="navbar-getting-started1">
                                                                        {{__('Double Entry')}}
                                                                        <i class="fas fa-sort-up"></i>
                                                                    </a>
                                                                    <div class="submenu-ul {{(Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')? 'show' :'collapse'}}"
                                                                            ...
                                                                            @can('manage chart of account')
                                                                                <li class="nav-item {{ (Request::route()->getName() == 'chart-of-account.index') ? ' active' : '' }}">
                                                                                    <a href="{{ route('chart-of-account.index') }}"
                                                                                       class="nav-link">{{ __('Chart of Accounts') }}</a>
                                                                                </li>
                                                                            @endcan
                                                                            ...
                                                                            @can('balance sheet report')
                                                                                <li class="nav-item {{ (Request::route()->getName() == 'report.balance.sheet' ) ? ' active' : '' }}">
                                                                                    <a href="{{route('report.balance.sheet')}}"
                                                                                       class="nav-link">{{ __('Balance Sheet') }}</a>
                                                                                </li>
                                                                            @endcan
                                                                            ...
                                                                            @can('trial balance report')
                                                                                <li class="nav-item {{ (Request::route()->getName() == 'trial.balance' ) ? ' active' : '' }}">
                                                                                    <a href="{{route('trial.balance')}}"
                                                                                       class="nav-link">{{ __('Trial Balance') }}</a>
                                                                                </li>
                                                                            @endcan
                                                                        </ul>
                                                                    </div>
                                                            ...
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    <a class="nav-link {{((Request::segment(1) == 'report' || Request::segment(1) == 'transaction') &&  Request::segment(2) != 'ledger' &&  Request::segment(2) != 'balance-sheet' &&  Request::segment(2) != 'trial-balance')? 'active' :'collapsed'}}"
                                                                       ...
                                                                       role="button"
                                                                       aria-expanded="{{((Request::segment(1) == 'report' || Request::segment(1) == 'transaction') &&  Request::segment(2) != 'ledger' &&  Request::segment(2) != 'balance-sheet' &&  Request::segment(2) != 'trial-balance')? 'true' :'false'}}"
                                                                       aria-controls="navbar-getting-started1">
                                                                        {{__('Report')}}
                                                                        <i class="fas fa-sort-up"></i>
                                                                    </a>
                                                                    <div class="submenu-ul {{((Request::segment(1) == 'report' || Request::segment(1) == 'transaction') &&  Request::segment(2) != 'ledger' &&  Request::segment(2) != 'balance-sheet' &&  Request::segment(2) != 'trial-balance')? 'show' :'collapse'}}"
                                                                         id="report-nav" style="">
                                                                        <ul class="nav flex-column">
                                                            ...
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    <a class="nav-link {{(Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'active' :'collapsed'}}"
                                                                       ...
                                                                       role="button"
                                                                       aria-expanded="{{(Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'true' :'false'}}"
                                                                       aria-controls="navbar-getting-started1">
                                                                        {{__('Setup')}}
                                                                        <i class="fas fa-sort-up"></i>
                                                                    </a>
                                                                    <div class="submenu-ul {{(Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'show' :'collapse'}}"
                                                                         id="account-setup-nav" style="">
                                                                        <ul class="nav flex-column">
                                                                            @can('manage constant tax')
                                                                                <li class="nav-item {{ (Request::route()->getName() == 'taxes.index' ) ? ' active' : '' }}">
                                                                                    <a href="{{ route('taxes.index') }}"
                                                                                       class="nav-link">{{ __('Taxes') }}</a>
                                                                                </li>
                                                                            @endcan
                                                                            ...
                                                                            @can('manage constant custom field')
                                                                                <li class="nav-item {{ (Request::route()->getName() == 'custom-field.index' ) ? 'active' : '' }}">
                                                                                    <a href="{{route('custom-field.index')}}"
                                                                                       class="nav-link">{{ __('Custom Field') }}</a>
                                                                                </li>
                                                                            @endcan
                                                                        </ul>
                                                                    </div>
                        ...
                        @if(Gate::check('manage product & service'))
                            <li class="nav-item">
                                <a href="{{ route('productservice.index') }}"
                                   class="nav-link {{ (Request::segment(1) == 'productservice')?'active':''}}">
                    ...
                    @if(\Auth::user()->type!='super admin' && \Auth::user()->type!='client')
                        <li class="nav-item">
                            <a href="{{ url('chats') }}"
                               class="nav-link {{ (Request::segment(1) == 'chats')?'active':''}}">
                    ...
                    @if(Gate::check('manage company settings'))
                        <li class="nav-item">
                            <a href="{{ route('company.setting') }}"
                               class="nav-link {{ (Request::segment(1) == 'company-setting') ? ' active' : '' }}">
                                <i class="fas fa-sliders-h"></i>
                                {{__('Settings')}}
                            </a>
                        </li>
            ...
            @if((\Auth::user()->type == 'client'))
                <ul class="navbar-nav navbar-nav-docs">
                    @if(Gate::check('manage client dashboard'))
                        <li class="nav-item">
                            <a href="{{ route('client.dashboard.view') }}"
                    ...
                    @if(Gate::check('manage deal'))
                        <li class="nav-item">
                            <a href="{{ route('deals.index') }}"
                               class="nav-link {{ (Request::segment(1) == 'deals') ? ' active' : '' }}">
                    ...
                    @if(Gate::check('manage project'))
                        <li class="nav-item">
                            <a href="{{ route('projects.index') }}"
                               class="nav-link {{ (Request::segment(1) == 'projects') ? ' active' : '' }}">
                    ...
                    @if(Gate::check('manage project task'))
                        <li class="nav-item">
                            <a href="{{ route('taskBoard.view', 'list') }}"
                               class="nav-link {{ (Request::segment(1) == 'taskboard') ? ' active' : '' }}">
                    ...
                    @if(Gate::check('manage bug report'))
                        <li class="nav-item">
                            <a href="{{ route('bugs.view','list') }}"
                               class="nav-link {{ (Request::segment(1) == 'bugs-report') ? ' active' : '' }}">
                    ...
                    @if(Gate::check('manage timesheet'))
                        <li class="nav-item">
                            <a href="{{ route('timesheet.list') }}"
                               class="nav-link {{ (Request::segment(1) == 'timesheet-list') ? ' active' : '' }}">
                    ...
                    @if(Gate::check('manage project task'))
                        <li class="nav-item">
                            <a href="{{ route('task.calendar',['all']) }}"
                               class="nav-link {{ (Request::segment(1) == 'calendar') ? ' active' : '' }}">
            ...
            @if((\Auth::user()->type == 'super admin'))
                <ul class="navbar-nav navbar-nav-docs">
                    ...
                    @can('manage user')
                        <li class="nav-item">
                            <a href="{{ route('users.index') }}"
                               class="nav-link {{ (Request::route()->getName() == 'users.index' || Request::route()->getName() == 'users.create' || Request::route()->getName() == 'users.edit') ? ' active' : '' }}">
                    ...
                    @if(Gate::check('manage coupon'))
                        <li class="nav-item">
                            <a href="{{ route('coupons.index') }}"
                               class="nav-link {{ (Request::segment(1) == 'coupons')?'active':''}}">
                    ...
                    @if(Gate::check('manage order'))
                        <li class="nav-item">
                            <a href="{{ route('order.index') }}"
                               class="nav-link {{ (Request::segment(1) == 'orders')?'active':''}}">
                                <i class="fas fa-cart-plus"></i>{{__('Order')}}
                            </a>
                        </li>
                    @endif
                    ...
                    @if(Gate::check('manage system settings'))
                        <li class="nav-item">
                            <a href="{{ route('systems.index') }}"
                               class="nav-link {{ (Request::route()->getName() == 'systems.index') ? ' active' : '' }}">
