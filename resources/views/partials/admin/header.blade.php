                    ...
                    <div class="dropdown global-icon" data-toggle="tooltip" data-original-titla="{{__('Choose Language')}}">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            @if(\Auth::user()->type=='super admin')
                                <a class="dropdown-item" href="{{route('manage.language',[isset($lang)?$lang:'en'])}}">{{ __('Create & Customize') }}</a>
                            @endcan
                            @foreach($languages as $language)
                                <a class="dropdown-item @if($language == $lang) text-danger @endif" href="{{route('change.language',$language)}}">{{Str::upper($language)}}</a>
                            @endforeach
                        </div>
                    </div>
                </li>
