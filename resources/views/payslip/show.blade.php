<div class="card bg-none card-box">
    <div class="col-md-12">
                    ...
                    <div class="col-lg-12 our-system">
                        <div class="row">
                            <ul class="nav nav-tabs my-4">
                                ...
                                <li>
                                    <a data-toggle="tab" href="#provident">{{__('Provident Funds')}}</a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#tax">{{__('Tax Dedutcion')}}</a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#eobi">{{__('EOBI Amount')}}</a>
                                </li>
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table align-items-center">
                                                        ...
                                                        @foreach($providents as $provident)
                                                            <tr>
                                                                <td>------------</td>
                                                                <td>{{ \Auth::user()->priceFormat($provident->employee_amount)}}</td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
                                                    </table>
        ...
        <!-- <div class="col-md-4 py-3">
            <h5 class="emp-title mb-0">{{__('Final Salary')}}</h5>
