                ...
                <div class="card-body">
                    <div class="table-responsive py-4">
                        <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            @php
                            @endphp
                            @foreach($opd_detail as $opd_data)
                                <tr>
                                    <td><strong>{{$opd_data['month_name']}}</strong></td>
                                    <td>{{$opd_data['name']}}</td>
                                    <td>{{$opd_data['amount']}}</td>
                                    <td>{{\Auth::user()->dateFormat($opd_data['date'])}}</td>
                                </tr>
                            @endforeach
                            </tbody>
