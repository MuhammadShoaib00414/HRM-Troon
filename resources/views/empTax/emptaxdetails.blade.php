...
@section('action-button')
    <div class="row d-flex justify-content-end">
        <div class="col-xl-4 col-lg-2">
            {{ Form::open(array('url' => array('employee-tax-details',request()->route('id')),'method'=>'get','id'=>'report_leave')) }}
                ...
                <div class="card-body">
                    <div class="table-responsive py-4">
                        <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <tbody>
                            @foreach($employeeTaxs as $emplTax)
                        
                                <tr>
                                    <td><strong>{{$emplTax['month_name']}}</strong></td>
                                    <td>{{$emplTax['name']}}</td>
                                    <td>{{$emplTax['total_tax_amount']}}</td>
