                ...
                <div class="card-body">
                    <div class="table-responsive py-4">
                        <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            @php
                            @endphp
                            @foreach($eobi_details as $eobi_data)
                                <tr>
                                    <td><strong>{{$eobi_data['month_name']}}</strong></td>
                                    <td>{{$eobi_data['name']}}</td>
                                    <td>{{$eobi_data['employee_amount']}}</td>
                                    <td>{{$eobi_data['employer_amount']}}</td>
                                    <td>{{\Auth::user()->dateFormat($eobi_data['date'])}}</td>
                                </tr>
                            @endforeach
                            </tbody>
                            <br>
