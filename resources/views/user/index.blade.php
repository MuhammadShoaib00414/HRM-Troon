            ...
            <div class="col-lg-3 col-sm-6 col-md-6">
                <div class="card profile-card">
                    ...
                    <div class="avatar-parent-child">
                        <img src="{{(!empty($user->avatar))? asset(url("/public/upload/avatar/".$user->avatar)): asset(url("/public/uploads/avatar/avatar.png"))}}" class="avatar rounded-circle avatar-xl">
                    </div>
                    ...
                    <h6 class="office-time mb-0 my-4">{{ $user->email }}</h6>
                    <small data-toggle="tooltip" data-placement="bottom" data-original-title="{{__('Last Login')}}">{{ (!empty($user->last_login_at)) ? $user->last_login_at : '-' }}</small>
