...
{{--                                        <input type="text" name="cookie_text" class="form-control" value="{{isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : ''}}">--}}
{{--                                    </div>--}}
                                    ...
                                    <div class="form-group col-12 mt-4 gdpr_cookie_text">
                                        <textarea id="btn" type="text" name="cookie_text" class="form-control" rows="4" style="height: auto"
                                                  value="{{ isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : '' }}" placeholder="{{ isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : '' }}">{{ isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : '' }}</textarea>
                                    </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-md-6">
                                ...
                                <div class="card setting-card">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="SITE_RTL" id="SITE_RTL" {{ $SITE_RTL == 'on' ? 'checked="checked"' : '' }}>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="skrill_email" id="skrill_email" class="form-control" value="{{ isset($admin_payment_setting['skrill_email'])?$admin_payment_setting['skrill_email']:''}}" placeholder="{{ __('Mollie Api Key') }}"/>
                    ...
                    <div id="pusher-settings" class="tab-pane">
                        ...
                        <div class="card bg-none company-setting">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    {{Form::label('pusher_app_id',__('Pusher App Id'),array('class'=>'form-control-label')) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{Form::label('pusher_app_key',__('Pusher App Key'),array('class'=>'form-control-label')) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{Form::label('pusher_app_secret',__('Pusher App Secret'),array('class'=>'form-control-label')) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{Form::label('pusher_app_cluster',__('Pusher App Cluster'),array('class'=>'form-control-label')) }}
                            ...
                            <div class="col-lg-12 text-right">
                                {{Form::submit(__('Save Change'),array('class'=>'btn-submit text-white'))}}
                            </div>
                        </div>
                        {{Form::close()}}
                    </div>
