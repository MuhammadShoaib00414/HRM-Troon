        ...
        <div class="col-md-8">
            <section class="nav-tabs">
                ...
                <div class="tab-content">
                    ...
                    @if(!empty($admin_payment_setting) && $admin_payment_setting['is_paypal_enabled'] == 'on' && !empty($admin_payment_setting['paypal_client_id']) && !empty($admin_payment_setting['paypal_secret_key']))
                    ...
                    @if(!empty($admin_payment_setting) && $admin_payment_setting['is_paystack_enabled'] == 'on' && !empty($admin_payment_setting['paystack_public_key']) && !empty($admin_payment_setting['paystack_secret_key']))
                    ...
                    @if(!empty($admin_payment_setting) && isset($admin_payment_setting['is_flutterwave_enabled']) && $admin_payment_setting['is_flutterwave_enabled'] == 'on')
                    ...
                    @if(!empty($admin_payment_setting) && isset($admin_payment_setting['is_razorpay_enabled']) && $admin_payment_setting['is_razorpay_enabled'] == 'on')
                    ...
                    @if(!empty($admin_payment_setting) && isset($admin_payment_setting['is_mercado_enabled']) && $admin_payment_setting['is_mercado_enabled'] == 'on')
                    ...
                    @if(!empty($admin_payment_setting) && isset($admin_payment_setting['is_paytm_enabled']) && $admin_payment_setting['is_paytm_enabled'] == 'on')
                    ...
                    @if(!empty($admin_payment_setting) && isset($admin_payment_setting['is_mollie_enabled']) && $admin_payment_setting['is_mollie_enabled'] == 'on')
                    ...
                    @if(!empty($admin_payment_setting) && isset($admin_payment_setting['is_skrill_enabled']) && $admin_payment_setting['is_skrill_enabled'] == 'on')
                    ...
                    @if(!empty($admin_payment_setting) && isset($admin_payment_setting['is_coingate_enabled']) && $admin_payment_setting['is_coingate_enabled'] == 'on')
