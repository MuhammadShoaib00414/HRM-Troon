    ...
    <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="number-icon"><?php echo e($countUser +   $countClient); ?></div>
                <div class="user-text">
                    <h5><?php echo e(__('Employee ')); ?> : <span class="text-dark text-sm"><?php echo e($countUser); ?></span></h5>
                    <h5><?php echo e(__('Client ')); ?> : <span class="text-dark text-sm"><?php echo e($countClient); ?></span></h5>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                <div class="left-card">
                    ...
                    <h4><?php echo e(__('Total Training')); ?></h4>
                </div>
                <div class="number-icon"><?php echo e($onGoingTraining +   $doneTraining); ?></div>
                <div class="user-text">
                    <h5><?php echo e(__('Trainer ')); ?> : <span class="text-dark text-sm"> <?php echo e($countTrainer); ?> </span></h5>
                    <h5><?php echo e(__('Active Training ')); ?> : <span class="text-dark text-sm"> <?php echo e($onGoingTraining); ?> </span></h5>
                    <h5><?php echo e(__('Done Training ')); ?> : <span class="text-dark text-sm"> <?php echo e($doneTraining); ?> </span></h5>
                </div>
            </div>
            <img src="<?php echo e(asset('assets/img/dot-icon.png')); ?>" alt="" class="dotted-icon">
        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="number-icon"><?php echo e($activeJob + $inActiveJOb); ?></div>
                <div class="user-text">
                    <h5><?php echo e(__('Active Job')); ?> : <span class="text-dark text-sm"><?php echo e($activeJob); ?></span></h5>
                    <h5><?php echo e(__('Inactive Job')); ?> : <span class="text-dark text-sm"><?php echo e($inActiveJOb); ?></span></h5>
                </div>
            </div>
            <img src="<?php echo e(asset('assets/img/dot-icon.png')); ?>" alt="" class="dotted-icon">
        </div>
