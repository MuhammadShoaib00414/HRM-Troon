...
<?php
    ...
    $profile=asset(url('/public/uploads/avatar/'));
?>
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12">
            <div class="card profile-card">
                <div class="icon-user avatar rounded-circle">
                    <img alt="" src="<?php echo e((!empty($userDetail->avatar))? $profile.'/'.$userDetail->avatar : $profile.'/avatar.png'); ?>">
                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="choose-file">
                                                <label for="avatar">
                                                    ...
                                                    <input type="file" class="form-control" id="avatar" accept="image/*" onchange="loadFile(event)" name="profile" data-filename="profiles">
                                                </label>
                                                <p class="profiles"></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/user/profile.blade.php ENDPATH**/ ?>