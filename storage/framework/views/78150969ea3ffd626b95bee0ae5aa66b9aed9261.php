                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <tr>
                                    ...
                                    <td><?php echo e(!empty($opdPayment['totalAmount']) ? \Auth::user()->priceFormat($opdPayment['totalAmount']) : '-'); ?></td>
                                    <?php else: ?>
                        ...
                        <?php if($grandTotal): ?>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <?php if(request('type') == 'yearly'): ?>
                                    <td><strong><?php echo e($opdPayment['totalAmount']); ?></strong></td>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/opdPayment/opdPayment.blade.php ENDPATH**/ ?>