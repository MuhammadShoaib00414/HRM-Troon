...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Employee EOBI  Details Page')); ?>
                ...
                <div class="card-body">
                    <div class="table-responsive py-4">
                        <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <?php
                            ?>
                            <?php $__currentLoopData = $eobi_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eobi_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><strong><?php echo e($eobi_data['month_name']); ?></strong></td>
                                    <td><?php echo e($eobi_data['name']); ?></td>
                                    <td><?php echo e($eobi_data['employee_amount']); ?></td>
                                    <td><?php echo e($eobi_data['employer_amount']); ?></td>
                                    <td><?php echo e(\Auth::user()->dateFormat($eobi_data['date'])); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                            <br>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/employee-eobi/eobi_status_details.blade.php ENDPATH**/ ?>