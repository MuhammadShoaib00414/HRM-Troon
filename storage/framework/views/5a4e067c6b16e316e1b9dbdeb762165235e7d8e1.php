    ...
    <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="user-text">
                    <h5><?php echo e(__('PAID USERS')); ?> : <span class="text-dark text-sm"><?php echo e($user['total_paid_user']); ?></span></h5>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="user-text">
                    <h5><?php echo e(__('Total Order Amount')); ?> : <span class="text-dark text-sm"><?php echo e((!empty(env('CURRENCY_SYMBOL'))?env('CURRENCY_SYMBOL'):'$').$user['total_orders_price']); ?></span></h5>
                </div>
            </div>
            <img src="<?php echo e(asset('assets/img/dot-icon.png')); ?>" alt="" class="dotted-icon">
        </div>
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="user-text">
                    <h5><?php echo e(__('Most Purchase Plan')); ?> : <span class="text-dark text-sm"><?php echo e($user['most_purchese_plan']); ?></span></h5>
                </div>
            </div>
            <img src="<?php echo e(asset('assets/img/dot-icon.png')); ?>" alt="" class="dotted-icon">
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/dashboard/super_admin.blade.php ENDPATH**/ ?>