<div class="card bg-none card-box">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('loan_option', __('Loan Options'),['class'=>'form-control-label'])); ?><span class="text-danger">*</span>
...
</script><?php /**PATH C:\xampp\htdocs\HRM\resources\views/loan/create.blade.php ENDPATH**/ ?>