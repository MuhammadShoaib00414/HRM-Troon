...
<?php
    $logo=asset(url('storage/uploads/logo/'));
    ...
    <div class="login-contain">
        <div class="login-inner-contain">
            <a class="navbar-brand" href="#">
                <img src="/public/logo/logo.png" class="navbar-brand-img big-logo" alt="logo">
            </a>
...
unset($__errorArgs, $__bag); ?>
            ...
            <h5 class="copyright-text">
                <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright Troon HRM')); ?> <?php echo e(date('Y')); ?>
