<div class="card bg-none card-box">
    <div class="col-md-12">
                    ...
                    <div class="col-lg-12 our-system">
                        <div class="row">
                            <ul class="nav nav-tabs my-4">
                                ...
                                <li>
                                    <a data-toggle="tab" href="#provident"><?php echo e(__('Provident Funds')); ?></a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#tax"><?php echo e(__('Tax Dedutcion')); ?></a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#eobi"><?php echo e(__('EOBI Amount')); ?></a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="provident" class="tab-pane">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card bg-none mb-0">
                                                <div class="table-responsive">
                                                    <?php
                                                        $providents = json_decode($payslip->provident);
                                                    ...
                                                    <table class="table align-items-center">
                                                        ...
                                                        <?php $__currentLoopData = $providents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td>------------</td>
                                                                <td><?php echo e(\Auth::user()->priceFormat($provident->employee_amount)); ?></td>
                                                            </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </tbody>
                                                    </table>
        ...
        <!-- <div class="col-md-4 py-3">
            <h5 class="emp-title mb-0"><?php echo e(__('Final Salary')); ?></h5>
            <h5 class="emp-title black-text"><?php echo e(\Auth::user()->priceFormat($payslip->net_payble)); ?></h5>
        </div> -->
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\HRM\resources\views/payslip/show.blade.php ENDPATH**/ ?>