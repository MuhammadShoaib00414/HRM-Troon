                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group" id="customer-box">
                                <div class="input-group">
                                    ...
                                    <?php echo e(Form::select('customer_id', $customers,$customerId, array('class' => 'form-control select2','id'=>'customer','data-url'=>route('invoice.customer'),'required'=>'required'))); ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('invoice_number', __('Invoice Number'),['class'=>'form-control-label'])); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('ref_number', __('Ref Number'),['class'=>'form-control-label'])); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-checkbox mt-4">
                                        ...
                                        <label class="custom-control-label form-control-label" for="discount_apply"><?php echo e(__('Discount Apply')); ?></label>
                                    </div>
                                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <th class="text-right"><?php echo e(__('Amount')); ?> <br><small class="text-danger font-weight-bold"><?php echo e(__('before tax & discount')); ?></small></th>
                                <th></th>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group price-input">
                                        ...
                                        <span><?php echo e(\Auth::user()->currencySymbol()); ?></span>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/invoice/create.blade.php ENDPATH**/ ?>