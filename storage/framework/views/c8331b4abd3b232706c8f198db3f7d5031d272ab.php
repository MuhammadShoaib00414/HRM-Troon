                            ...
                            <div class="col-lg-3 col-sm-6 col-md-6">
                                ...
                                <div class="card setting-card setting-logo-box">
                                    ...
                                    <div class="form-group col-12 mt-4">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="gdpr_cookie" id="gdpr_cookie" <?php echo e(isset($settings['gdpr_cookie']) && $settings['gdpr_cookie'] == 'on' ? 'checked="checked"' : ''); ?>>
                                    ...
                                    <div class="form-group col-12 mt-4 gdpr_cookie_text">
                                        <textarea id="btn" type="text" name="cookie_text" class="form-control" rows="4" style="height: auto"
                                                  value="<?php echo e(isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : ''); ?>" placeholder="<?php echo e(isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : ''); ?>"><?php echo e(isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : ''); ?></textarea>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="SITE_RTL" id="SITE_RTL" <?php echo e($SITE_RTL == 'on' ? 'checked="checked"' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="skrill_email" id="skrill_email" class="form-control" value="<?php echo e(isset($admin_payment_setting['skrill_email'])?$admin_payment_setting['skrill_email']:''); ?>" placeholder="<?php echo e(__('Mollie Api Key')); ?>"/>
                    ...
                    <div id="pusher-settings" class="tab-pane">
                        ...
                        <div class="card bg-none company-setting">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <?php echo e(Form::label('pusher_app_id',__('Pusher App Id'),array('class'=>'form-control-label'))); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    <?php echo e(Form::label('pusher_app_key',__('Pusher App Key'),array('class'=>'form-control-label'))); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    <?php echo e(Form::label('pusher_app_secret',__('Pusher App Secret'),array('class'=>'form-control-label'))); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    <?php echo e(Form::label('pusher_app_cluster',__('Pusher App Cluster'),array('class'=>'form-control-label'))); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12 text-right">
                                <?php echo e(Form::submit(__('Save Change'),array('class'=>'btn-submit text-white'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/settings/index.blade.php ENDPATH**/ ?>