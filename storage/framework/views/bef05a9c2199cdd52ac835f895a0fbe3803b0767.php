<div class="card bg-none card-box">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            <?php echo e(Form::label('deduction_option', __('Deduction Options'),['class'=>'form-control-label'])); ?><span class="text-danger">*</span>
...
</script><?php /**PATH C:\xampp\htdocs\HRM\resources\views/saturationdeduction/create.blade.php ENDPATH**/ ?>