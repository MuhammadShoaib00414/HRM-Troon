...
<?php echo e(Form::model($tax,array('route' => array('tax.update', $tax->id), 'method' => 'PUT'))); ?>

    <?php echo csrf_field(); ?>
    <?php echo e(Form::hidden('employee_id',$tax->id, array())); ?>
...
</script><?php /**PATH C:\xampp\htdocs\HRM\resources\views/tax/edit.blade.php ENDPATH**/ ?>