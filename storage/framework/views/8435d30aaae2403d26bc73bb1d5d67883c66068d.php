...
<?php $__env->startSection('action-button'); ?>
    <div class="row d-flex justify-content-end">
        ...
        <div class="col-auto my-custom">
            ...
            <a href="<?php echo e(route('report.leave')); ?>" class="reset-btn" data-toggle="tooltip"
                    ...
                    <div class="table-responsive py-4">
                        <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Causal Leave')); ?></th>
                                <th><?php echo e(__('Sick Leave')); ?></th>
                                <th><?php echo e(__('Annual Leave')); ?></th>
                                <!-- <th><?php echo e(__('Total used Leave')); ?></th> -->
                                <!-- <th><?php echo e(__('Total Additional Leave')); ?></th> -->
                                <!-- <th><?php echo e(__('Remaining Leave')); ?></th>  -->
                            ...
                            <tbody>
                            <?php $__currentLoopData = $leaveArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           
                                <tr>
                                    <td><?php echo e(\Auth::user()->employeeIdFormat($leave['employee_id'])); ?></td>
                                    <td><?php echo e($leave['employee']); ?></td>
                                   <?php if(!empty($leave['casual_Leave'])): ?>
                                         <td><?php echo e(($leave['casual_Leave'])); ?></td>
                                   <?php else: ?>
                                         <td><?php echo e('0'); ?> </td> 
                                   <?php endif; ?> 

                                   <?php if(!empty($leave['sick_leave'])): ?>
                                         <td><?php echo e(($leave['sick_leave'])); ?></td>
                                   <?php else: ?>
                                         <td><?php echo e('0'); ?> </td> 
                                   <?php endif; ?>

                                   <?php if(!empty($leave['annual_leave'])): ?>
                                         <td><?php echo e(($leave['annual_leave'])); ?></td>
                                   <?php else: ?>
                                          <td><?php echo e('0'); ?> </td> 
                                   <?php endif; ?>

                                   <!-- <?php if(!empty($leave['additional_leave'])): ?>
                                         <td><?php echo e(($leave['additional_leave'])); ?></td>
                                   <?php else: ?>
                                         <td><?php echo e('0'); ?> </td> 
                                   <?php endif; ?> -->

                                   <!-- <?php if(!empty($leave['Remaining Leave'])): ?>
                                         <td><?php echo e(($leave['additional_leave'])); ?></td>
                                   <?php else: ?>
                                         <td><?php echo e('0'); ?> </td> 
                                   <?php endif; ?>  -->
<!-- 
                                   <?php if(!empty($leave['remaing_leave'])): ?>
                                         <td><?php echo e(($leave['remaing_leave'])); ?></td>
                                   <?php else: ?>
                                         <td><?php echo e('0'); ?> </td> 
                                   <?php endif; ?> -->
                                    ...
                                    <td>
                                        <div class="m-view-btn badge-success"><?php echo e($leave['approved']); ?>
                                            ...
                                            <a href="#"
                                               data-url="<?php echo e(route('report.employee.leave',[$leave['id'],'Approve',isset($_GET['type']) ?$_GET['type']:'no',isset($_GET['month'])?$_GET['month']:date('Y-m'),isset($_GET['year'])?$_GET['year']:date('Y')])); ?>"
                                               data-ajax-popup="true" data-title="<?php echo e(__('Approved Leave Detail')); ?>"
                                               data-toggle="tooltip"
                                    ...
                                    <td>
                                        <div class="m-view-btn badge-danger"><?php echo e($leave['reject']); ?>
                                            ...
                                            <a href="#"
                                               ...
                                               class="table-action table-action-delete" data-ajax-popup="true"
                                               data-title="<?php echo e(__('Rejected Leave Detail')); ?>" data-toggle="tooltip"
                                               data-original-title="<?php echo e(__('View')); ?>"><?php echo e(__('View')); ?></a>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="m-view-btn m-blue-bg"><?php echo e($leave['pending']); ?>
                                            ...
                                            <a href="#"
                                               ...
                                               class="table-action table-action-delete" data-ajax-popup="true"
                                               data-title="<?php echo e(__('Pending Leave Detail')); ?>" data-toggle="tooltip"
                                               data-original-title="<?php echo e(__('View')); ?>"><?php echo e(__('View')); ?></a>
                                        </div>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/report/leave.blade.php ENDPATH**/ ?>