...
<?php $__env->startSection('action-button'); ?>
    <div class="row d-flex justify-content-end">
        <div class="col-xl-5 col-lg-2">
            <?php echo e(Form::open(array('url' => array('employee-eobi'),'method'=>'get','id'=>'report_leave'))); ?>
                ...
                <div class="btn-box">
                    ...
                    <div class="d-flex radio-check">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="monthly" value="monthly" name="type" class="custom-control-input monthly" <?php echo e(isset($_GET['type']) && $_GET['type']=='monthly' ?'checked':''); ?>>
                            <label class="custom-control-label" for="monthly"><?php echo e(__('Monthly')); ?></label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="yearly" value="yearly" name="type" class="custom-control-input yearly" <?php echo e(isset($_GET['type']) && $_GET['type']=='yearly' ?'checked':'checked'); ?>>
        ...
        <div class="col-auto my-custom">
            ...
            <a href="<?php echo e(url('employee-eobi')); ?>" class="reset-btn" data-toggle="tooltip" data-original-title="<?php echo e(__('Reset')); ?>">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $employeeEobi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleobi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                    <td><?php echo e(\Auth::user()->employeeIdFormat($empleobi['employee_id'])); ?></td>
                                    <td><?php echo e($empleobi['name']); ?></td>
                                    <td><?php echo e(!empty($empleobi['employee_amount']) ? \Auth::user()->priceFormat($empleobi['employee_amount']) : '-'); ?></td>
                                <td><?php echo e(!empty($empleobi['employer_amount']) ? \Auth::user()->priceFormat($empleobi['employer_amount']) : '-'); ?></td>

                                <td><?php echo e(\Auth::user()->dateFormat($empleobi['date'])); ?></td>
                                 </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/employee-eobi/index.blade.php ENDPATH**/ ?>