...
<?php $__env->startSection('content'); ?>
    ...
    <div id="printableArea" class="mt-4">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h5 class="report-text gray-text mb-0"><?php echo e(__('Provident Funds')); ?> :</h5>
                    <h5 class="report-text mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalprovidentPayment'])); ?></h5>
                </div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h5 class="report-text gray-text mb-0"><?php echo e(__('Tax Dedutcion')); ?> :</h5>
                    <h5 class="report-text mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totaltaxPayment'])); ?></h5>
                </div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h5 class="report-text gray-text mb-0"><?php echo e(__('EOBI Amount')); ?> :</h5>
                    <h5 class="report-text mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totaleobiPayment'])); ?></h5>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/report/payroll.blade.php ENDPATH**/ ?>