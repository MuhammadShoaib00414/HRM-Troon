    ...
    <div class="row">
        <div class="col-md-6 ">
            <div class="card card-fluid">
                <div class="card-header"><h6 class="mb-0"><?php echo e(__('Personal Information')); ?></h6></div>
                <div class="card-body employee-detail-edit-body">

                    <div class="row">
                    <div class="form-group col-md-12">
                            <?php echo Form::label('name', __('username'),['class'=>'form-control-label']); ?><span class="text-danger pl-1">*</span>
                            <?php echo Form::text('name', null, ['class' => 'form-control','required' => 'required']); ?>

                         
                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('fname', __('First Name'),['class'=>'form-control-label']); ?><span class="text-danger pl-1">*</span>
                            <?php echo Form::text('fname', null, ['class' => 'form-control','required' => 'required']); ?>

                            <!-- &nbsp;<span class="errmsg"></span> -->
                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('last name', __('Last Name'),['class'=>'form-control-label']); ?><span class="text-danger pl-1">*</span>
                            <?php echo Form::text('lname',null, ['class' => 'form-control','required' => 'required']); ?>

                        </div>

                        <div class="form-group col-md-6">
                            <?php echo Form::label('cnic', __('CNIC Number'),['class'=>'form-control-label']); ?><span class="text-danger pl-1">*</span>
                        
                            <input class="form-control" type="number" name="cnic" id="cnic"
                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                            type = "number"
                            maxlength = "13" required value="<?php echo e(($employee['cnic'])); ?>">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="d-flex radio-check">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="g_male" value="Male" required name="gender" class="custom-control-input" <?php echo e(($employee->gender == 'Male')?'checked':''); ?>>
                                        <label class="custom-control-label" for="g_male"><?php echo e(__('Male')); ?></label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="g_female" required value="Female" name="gender" class="custom-control-input" <?php echo e(($employee->gender == 'Female')?'checked':''); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <?php echo Form::label('personalemail', __('Personal Email'),['class'=>'form-control-label']); ?><span class="text-danger pl-1">*</span>
                                <?php echo Form::email('personal_email', null, ['class' => 'form-control form-control','required' => 'required']); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <?php echo Form::label('officialemail', __('Official Email'),['class'=>'form-control-label']); ?>

                                <?php echo Form::email('email', null, array('class' => 'form-control','disabled'=>'disabled')); ?>

                            </div>
                        </div>
                       
                        <div class="form-group col-md-6">
                            <label for="religion" class="form-control-label"><?php echo e(__('Religion')); ?></label>
                             <select class="form-control select2 select2-hidden-accessible"  name="religion" id="religion">
                              <option value="" selected disabled><?php echo e(__('Islam')); ?></option>
                                <option value="0"  <?php echo e(($employee['religion']) == '0' ? 'selected' : ''); ?> >Hindu </option>
                                <option value="1"  <?php echo e(($employee['religion']) == '1' ? 'selected' : ''); ?> >Islam </option>
                                <option value="2"  <?php echo e(($employee['religion']) == '2' ? 'selected' : ''); ?>>Christianity </option>

                            </select>
                        </div>
                       
                        <div class="form-group col-md-6">
                            <label class="form-control-label" for="nationality"><?php echo e(__('Nationality')); ?></label>
                        ...
                        <div class="col-md-6">
                            <label for="blood"><?php echo e(__('Citizenship')); ?></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <?php echo Form::label('reference', __('Reference'),['class'=>'form-control-label']); ?>

                                <?php echo Form::text('reference', null, array('class' => 'form-control')); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                            type = "number"
                            maxlength = "12" value="<?php echo e(($employee['phone'])); ?>">
                         <span id="phone_msg"> </span>
                         <span id="phone_success"> </span>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('Company Date Of Joining', __('Company Date Of Joining'),['class'=>'form-control-label']); ?><span class="text-danger pl-1">*</span>
        ...
        <div class="col-md-6">
                <div class="card card-fluid">
                    <div class="card-header"><h6 class="mb-0"><?php echo e(__('Profile Picture')); ?></h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <?php echo csrf_field(); ?>
                          ...
                          <?php if($employee->profile_image): ?>
                            <img download  src="<?php echo e('/public/uploads/profile/'.$employee->profile_image); ?>" id="output"  width="500" alt="" title="" width="400" data-filename="profile_filenames">                                
            ...
            <div class="col-md-6 ">
                <div class="card card-fluid">
                    <div class="card-header"><h6 class="mb-0"><?php echo e(__('Professional Information')); ?></h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <?php echo csrf_field(); ?>
                         
                            <div class="form-group col-md-6">
                                <?php echo e(Form::label('employer_name', __('Employer Name'),['class'=>'form-control-label'])); ?>

                                <?php echo Form::text('employer_name', null, ['class' => 'form-control']); ?>


                            </div>
                           
                            <div class="form-group col-md-6">
                                <?php echo Form::label('pro_designation', 'Designation',['class'=>'form-control-label']); ?>

                                <?php echo Form::text('pro_designation', null, ['class' => 'form-control']); ?>

                            </div>

                            <div class="form-group col-md-6">
                                <?php echo Form::label('professional_start_date', 'Start Date',['class'=>'form-control-label']); ?>

                                <?php echo Form::date('professional_start_date', null, ['class' => 'form-control']); ?>

                            </div>

                            <div class="form-group col-md-6">
                                <?php echo Form::label('professional_end_date', 'End Date',['class'=>'form-control-label']); ?>

                                <?php echo Form::date('professional_end_date', null, ['class' => 'form-control']); ?>

                            </div>
                            <div class="form-group col-md-6">
                                <?php echo Form::label('experience_letter', 'Experience Letter',['class'=>'form-control-label']); ?>
                            ...
                            <div class="choose-file form-group">
                              ...
                              <a  download href="<?php echo e('/public/uploads/experienceLetter/'.$employee->experience_letter); ?>"><i class="fa fa-download"> <?php echo e($employee->experience_letter); ?></i></a>                                
                             <?php endif; ?>
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                <?php echo Form::label('reference_name', 'Reference Name',['class'=>'form-control-label']); ?>

                                <?php echo Form::text('reference_name', null, ['class' => 'form-control']); ?>
                               ...
                               <div class="form-group col-md-6">
                            <?php echo Form::label('refeance_number', __('Reference Phone Number'),['class'=>'form-control-label']); ?>

                            <input class="form-control" type="number" name="refeance_number" id="refeance_number"
                                   oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                   type = "number"
                                   maxlength = "12" value="<?php echo e(($employee['refeance_number'])); ?>">
                             <span id="refeance_number_msg"> </span>
                             <span id="refeance_number_success"> </span>
                        </div>
                            <div class="form-group col-md-12">
                                <?php echo Form::label('refeance_email', 'Reference Email',['class'=>'form-control-label']); ?>

                                <?php echo Form::email('refeance_email', null, ['class' => 'form-control']); ?>
            ...
            <div class="col-md-6 ">
                <div class="card card-fluid">
                    <div class="card-header"><h6 class="mb-0"><?php echo e(__('Education Information')); ?></h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <?php echo csrf_field(); ?>
                            <div class="form-group col-md-6">
                                <?php echo e(Form::label('insititution_name', __('Insititution Name'),['class'=>'form-control-label'])); ?>

                                <?php echo Form::text('insititution_name', null, ['class' => 'form-control']); ?>

                            </div>
                            <div class="form-group col-md-6">
                                <?php echo Form::label('educational_start_date', 'Start Date',['class'=>'form-control-label']); ?>

                                <?php echo Form::date('educational_start_date', null, ['class' => 'form-control']); ?>

                            </div>
                            <div class="form-group col-md-6">
                                <?php echo Form::label('educational_end_date', 'End Date',['class'=>'form-control-label']); ?>

                                <?php echo Form::date('educational_end_date', null, ['class' => 'form-control']); ?>

                            </div>

                            <div class="form-group col-md-6">
                                <?php echo Form::label('name_degree', 'Name of Degree',['class'=>'form-control-label']); ?>

                                <?php echo Form::text('name_degree', null, ['class' => 'form-control']); ?>

                            </div>

                            <div class="form-group col-md-6">
                                <?php echo Form::label('specialization', 'Specialization',['class'=>'form-control-label']); ?>
                            ...
                            <div class="form-group col-md-6">
                                <?php echo Form::label('degree_level', 'Degree Level',['class'=>'form-control-label']); ?>

                                <?php echo Form::text('degree_level', null, ['class' => 'form-control']); ?>

                            </div>
                            
                            <div class="form-group col-md-6">
                                <?php echo Form::label('degree_copy', 'Degree Copy',['class'=>'form-control-label']); ?>
                            ...
                            <?php if($employee->degree_copy): ?>
                              <a  download href="<?php echo e('/public/uploads/degree/'.$employee->degree_copy); ?>"><i class="fa fa-download"> <?php echo e($employee->degree_copy); ?></i></a>                                
                             <?php endif; ?>
                        </div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?> border-0" <?php if($document->is_required == 1 && empty($employeedoc[$document->id]) ): ?> required <?php endif; ?> name="document[<?php echo e($document->id); ?>]" type="file" id="document[<?php echo e($document->id); ?>]" data-filename="<?php echo e($document->id.'_filename'); ?>">
                                        ...
                                        <?php if(!empty($employeedoc[$document->id])): ?>
                                            <br> <span class="text-xs"><a download href="<?php echo e((!empty($employeedoc[$document->id])?asset(url('/public/uploads/document')).'/'.$employeedoc[$document->id]:'')); ?>" target="_blank"><?php echo e((!empty($employeedoc[$document->id])?$employeedoc[$document->id]:'')); ?></a>
                                                    </span>
                                        <?php endif; ?>
                                    </div>
            ...
            <div class="col-md-6">
                <div class="card card-fluid">
                    <div class="card-header"><h6 class="mb-0"><?php echo e(__('Contract Information')); ?></h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                             <?php echo csrf_field(); ?>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('basic_salary', __('Basic Salary'),['class'=>'form-control-label']); ?>

                            <?php echo Form::number('basic_salary', null, ['class' => 'form-control']); ?>


                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('hourly_rate', __('Hourly Rate'),['class'=>'form-control-label']); ?>

                            <?php echo Form::number('hourly_rate', null, ['class' => 'form-control']); ?>
                        ...
                        <div class="form-group col-md-6" data-select2-id="7">
                            <label for="role" class="form-control-label">Payslip Type</label>
                             ...
                             <option value="" selected="" disabled="">Select Payslip Type</option>
                               <option value="month" <?php echo e(($employee['salaries_type']) == 'month' ? 'selected' : ''); ?>>Per Month</option>
                               <option value="year" <?php echo e(($employee['salaries_type']) == 'year' ? 'selected' : ''); ?>>Per Year</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            <?php echo Form::label('contract_start_date', __('Contract Start Date'),['class'=>'form-control-label']); ?>

                            <?php echo Form::date('contract_start_date',null, ['class' => 'form-control ']); ?>

                        </div>

                        <div class="form-group col-md-6">
                            <?php echo Form::label('contract_end_date', __('Contract End Date'),['class'=>'form-control-label']); ?>

                            <?php echo Form::date('contract_end_date',null, ['class' => 'form-control ']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('reporting_to', __('Reporting To'),['class'=>'form-control-label']); ?>

                            <?php echo Form::text('reporting_to',null, ['class' => 'form-control']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('office_time', __('Office Shift Timing and Hours'),['class'=>'form-control-label']); ?>

                            <?php echo Form::number('office_time',null, ['class' => 'form-control']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('benefits_details', __('Note'),['class'=>'form-control-label']); ?>

                            <?php echo Form::text('benefits_details',null, ['class' => 'form-control']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('employment_status', __('Employment Status'),['class'=>'form-control-label']); ?>

                            <?php echo Form::text('employment_status',null, ['class' => 'form-control']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('contract_department', __('Department'),['class'=>'form-control-label']); ?>

                            <?php echo Form::text('contract_department',null, ['class' => 'form-control']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('contract_designation', __('Designation'),['class'=>'form-control-label']); ?>

                            <?php echo Form::text('contract_designation',null, ['class' => 'form-control']); ?>
                        ...
                        <?php if($employee->contract_copy): ?>
                          ...
                          <span class="text-xs"><a download  href="<?php echo e('/public/uploads/contract/'.$employee->contract_copy); ?>" target="_blank"><?php echo e($employee->contract_copy); ?></a>
                                                    </span>
    ...
    <?php endif; ?>
        ...
        <br>
                <div class="card card-fluid">
                    ...
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <?php echo csrf_field(); ?>
                            <div class="form-group col-md-6">
                                <?php echo Form::label('father_name', __('Fathers Name'),['class'=>'form-control-label']); ?>
                             ...
                             <div class="form-group col-md-6">
                                <?php echo Form::label('mother_name', __('Mothers Name'),['class'=>'form-control-label']); ?>

                                <?php echo Form::text('mother_name',null, ['class' => 'form-control']); ?>

                            </div>
                            <div class="form-group col-md-6">
                            <label for="marital_status" class="form-control-label"><?php echo e(__('Marital Status')); ?></label>
                             <select class="form-control select2 select2-hidden-accessible"  name="marital_status" id="marital_status">
                             <option value="" selected disabled><?php echo e(__('Select Marital Status')); ?></option>
                                ...
                                <option value="divorced" <?php echo e(($employee['marital_status']) == 'divorced' ? 'selected' : ''); ?>> Divorced or Separated </option>

                            </select>
                           </div>

                            <div class="form-group col-md-6">
                                <?php echo Form::label('wifename', __('Wife Name'),['class'=>'form-control-label']); ?>

                                <?php echo Form::text('wife_name',null, ['class' => 'form-control']); ?>

                            </div>

                            <div class="form-group col-md-6">
                                <?php echo Form::label('wife_cnic', __('Wife CNIC'),['class'=>'form-control-label']); ?>

                               
                                <input class="form-control" type="number" name="wife_cnic" id="wife_cnic"
                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                            type = "number"
                            maxlength = "13" value="<?php echo e(($employee['wife_cnic'])); ?>">
                            ...
                            <div class="form-group col-md-6">
                                <?php echo Form::label('wife_dob', __('Wife DOB'),['class'=>'form-control-label']); ?>

                                <?php echo Form::date('wife_dob',null, ['class' => 'form-control']); ?>
                            ...
                            <!-- <div class="col-md-12">
                                ...
                                <?php if($resultfamily): ?>
                                    ...
                                    <tr >
                                        <td class="form-group col-md-12"><input type="text" name="children_name[]" value="<?php echo e($family['name']); ?>" placeholder="Children Name" class="form-control" /></td>
                                        <td class="form-group col-md-12"><input type="date" name="children_dob[]" value="<?php echo e($family['dob']); ?>" placeholder="Children Detail" class="form-control" /></td> 
                                        ...
                                        <option value="m" <?php echo e(($family['gender']) == 'm' ? 'selected' : ''); ?>><?php echo e(__('Male ')); ?></option>
                                        <option value="f" <?php echo e(($family['gender']) == 'f' ? 'selected' : ''); ?>><?php echo e(__('Female ')); ?></option>
                                        </select>
                                    </td>
                                        ...
                                        <div class="card-body py-0">
                                            <div class="table-responsive">
                                                <table class="table table-striped mb-0" data-repeater-list="accounts" id="sortable-table" >
                                                    <thead>
                                                    <tr>
                                                        <th><?php echo e(__('Children Name')); ?></th>
                                                        <th><?php echo e(__('Children DOB')); ?></th>
                                                        <th><?php echo e(__('Children Gender')); ?> </th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-group price-input">
                                                                <?php echo e(Form::text('children_name','', array('class' => 'form-control children_name','placeholder'=>__('Children Name')))); ?>

                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group price-input">
                                                                <?php echo e(Form::date('children_dob','', array('class' => 'form-control children_dob','placeholder'=>__('Children Dob')))); ?>
                                                ...
                                                <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                                                    <div class="all-button-box">
                                                        <a href="#" data-repeater-create="" class="btn btn-xs btn-white btn-icon-only width-auto" data-toggle="modal" data-target="#add-bank">
                                                            <i class="fas fa-plus"></i> <?php echo e(__('Add more..')); ?>
                ...
                <div class="card card-fluid">
                    ...
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <?php echo csrf_field(); ?>
                            <div class="form-group col-md-6">
                                <?php echo Form::label('emergency_name', __('Full Name'),['class'=>'form-control-label']); ?>

                                <?php echo Form::text('emergency_name', null,['class' => 'form-control']); ?>

                            </div>
                            <div class="form-group col-md-6">
                                <?php echo e(Form::label('emergency_relation', __('Relationship'),['class'=>'form-control-label'])); ?>

                                <?php echo Form::text('emergency_relation', null, ['class' => 'form-control']); ?>

                            </div>
                           
                            <div class="form-group col-md-6">
                                <?php echo Form::label('emergency_number', 'Emergency Contact Number',['class'=>'form-control-label']); ?>

                                <!-- <?php echo Form::number('emergency_number', null, ['class' => 'form-control']); ?>

                             -->
                             <input class="form-control" type="number" name="emergency_number" id="emergency_number"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                type = "number"
                                maxlength = "13"  value="<?php echo e(($employee['emergency_number'])); ?>">
                            ...
                            <div class="form-group col-md-6">
                            <label for="blood_group" class="form-control-label"><?php echo e(__('Blood Group')); ?></label>
                            ...
                            <div class="form-group col-md-12">
                                <?php echo Form::label('emergency_address', 'Emergency Address',['class'=>'form-control-label']); ?>

                              
                                <?php echo Form::textarea('emergency_address',null, ['class' => 'form-control','rows'=>2]); ?>
            ...
            <div class="col-md-6">
                <br>
                <div class="card card-fluid">
                    <div class="card-header"><h6 class="mb-0"><?php echo e(__('Social Profile')); ?></h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                        <div class="form-group col-md-12">
                            <?php echo Form::label('facebook', __('Facebook'),['class'=>'form-control-label']); ?>
                        ...
                        <div class="form-group col-md-12">
                            <?php echo Form::label('twitter', __('Twitter'),['class'=>'form-control-label']); ?>
                        ...
                        <div class="form-group col-md-12">
                            <?php echo Form::label('linkedin', __('Linkedin In'),['class'=>'form-control-label']); ?>
            ...
            <div class="col-md-6 ">
                <br>
                <div class="card card-fluid">
                    <div class="card-header"><h6 class="mb-0"><?php echo e(__('Assets')); ?></h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                <td class="form-group"><input type="text" name="device_name[]" placeholder="Document Name" value="<?php echo e($assets['name']); ?>" class="form-control" /></td>
                                <td class="form-group"><input type="text" name="device_details[]" placeholder="Document Type" value="<?php echo e($assets['details']); ?>" class="form-control" /></td> 
       ...
       <div class="col-md-6">
           <br>
                    ...
                    <div class="card-body employee-detail-edit-body">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="number" name="account_number" id="account_number"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                type = "number"
                                maxlength = "14"  value="<?php echo e(($employee['account_number'])); ?>">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <?php echo Form::number('bank_identifier_code',null, ['class' => 'form-control']); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <?php echo Form::number('tax_payer_id',null, ['class' => 'form-control']); ?>
            ...
            <div class="col-md-6">
                <br>
                <div class="card card-fluid">
                    <div class="card-header"><h6 class="mb-0"><?php echo e(__('Address')); ?></h6></div>
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                        <div class="form-group col-md-6">
                            <?php echo Form::label('province', __('State / Province'),['class'=>'form-control-label']); ?>
                        ...
                        <div class="form-group col-md-12">
                            <?php echo Form::label('zip_code', __('Zip Code / Postal Code'),['class'=>'form-control-label']); ?>

                            <?php echo Form::number('zip_code', null, ['class' => 'form-control']); ?>


                        </div>
                        <div class="form-group col-md-12">
                            <?php echo Form::label('present_address', __('Present Address'),['class'=>'form-control-label']); ?>

                            <?php echo Form::textarea('present_address',null, ['class' => 'form-control','rows'=>2]); ?>

                        </div>
                        <div class="form-group col-md-12">
                            <?php echo Form::label('permanent_address', __('Permanent Address'),['class'=>'form-control-label']); ?>

                            <?php echo Form::textarea('permanent_address',null, ['class' => 'form-control','rows'=>2]); ?>
...
jQuery('#cninc2_msg').text('OK');
	 ...
	 $("#add").click(function() {
		++i;
		$("#dynamicTable").append('<tr><td><input type="text" name="children_name[]"  id="children_name" value="" placeholder="Childeren Name" class="form-control" /></td><td class="form-group"><input type="date" name="children_dob[]" placeholder="Children DOB" class="form-control" /></td><td class="form-group"><select name="children_gender[]" value="" id="gender" class="form-control"><option value="" selected disabled><?php echo e(__("Select Gender")); ?></option><option value="m"><?php echo e(__("Male")); ?></option><option value="f"><?php echo e(__("Female")); ?></option></select></td><td><button type="button" class="btn-create btn-xs badge-danger radius-10px float-right remove-tr">Remove</button></td></tr>');
	});
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/employee/edit.blade.php ENDPATH**/ ?>