            ...
            <div class="col-lg-3 col-sm-6 col-md-6">
                <div class="card profile-card">
                    ...
                    <div class="avatar-parent-child">
                        <img src="<?php echo e((!empty($user->avatar))? asset(url("/public/upload/avatar/".$user->avatar)): asset(url("/public/uploads/avatar/avatar.png"))); ?>" class="avatar rounded-circle avatar-xl">
                    </div>
                    ...
                    <h6 class="office-time mb-0 my-4"><?php echo e($user->email); ?></h6>
                    <small data-toggle="tooltip" data-placement="bottom" data-original-title="<?php echo e(__('Last Login')); ?>"><?php echo e((!empty($user->last_login_at)) ? $user->last_login_at : '-'); ?></small>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/user/index.blade.php ENDPATH**/ ?>