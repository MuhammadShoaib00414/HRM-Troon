                    ...
                    <div class="card-body">
                        <?php $__currentLoopData = $home_data['project_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row align-items-center mb-4">
                                ...
                                <div class="col">
                                    <span class="d-block h6 mb-0"><?php echo e(__(\App\Models\Project::$project_status[$status])); ?></span>
                                </div>
                            </div>
                                        ...
                                        <a href="<?php echo e(route('projects.show',$due_project)); ?>" class="list-group-item list-group-item-action">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="flex-fill pl-3 text-limit">
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <h6 class="progress-text mb-1 text-sm d-block text-limit"><?php echo e($due_project->name); ?></h6>
                                                        </div>
                                                        <div class="col-3 text-right">
                                                            <span class="badge badge-xs badge-<?php echo e((\Auth::user()->checkProject($due_project->id) == 'Owner') ? 'success' : 'warning'); ?>"><?php echo e(\Auth::user()->checkProject($due_project->id)); ?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between text-xs text-muted text-right mt-1">
                                                        <div>
                                                            <span class="font-weight-bold text-<?php echo e(\App\Models\Project::$status_color[$due_project->status]); ?>"><?php echo e(\App\Models\Project::$project_status[$due_project->status]); ?></span>
                                                        </div>
                                                        <div>
                                    ...
                                    <th scope="row">
                                        <div class="media align-items-center">
                                            <div class="media-body ml-4">
                                                <a href="<?php echo e(route('projects.tasks.index',$due_task->project->id)); ?>" class="name mb-0 h6 text-sm"><?php echo e($due_task->name); ?></a>
                                            </div>
                                        </div>
                                    </th>
                                    <td class="budget"><?php echo e($due_task->project->project_name); ?></td>
                                    <td>
                                    ...
                                    <div class="card border shadow-none">
                                        <div class="px-3 py-2 row align-items-center">
                                            ...
                                            <div class="col-2 card-meta d-inline-flex align-items-center">
                                                <button class="btn btn-sm btn-white float-right add-small" type="submit" id="todo_submit">
                                                    <i class="fas fa-plus "></i>
                                                </button>
                                            </div>
                                        </div>
...
<?php $__env->startPush('script-page'); ?>
        <script>
            ...
            var t = {
                ...
                series: [{name: "Tasks ", data: <?php echo json_encode(array_values($home_data['task_overview'])); ?>}],
            ...
            var t1 = {
                ...
                series: [{name: "Timesheet hours ", data: <?php echo json_encode(array_values($home_data['timesheet_logged'])); ?>}],
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/dashboard/project-dashboard.blade.php ENDPATH**/ ?>