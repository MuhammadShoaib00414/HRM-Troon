    ...
    <script>
        Fullcalendar = function () {
            ...
            a.length && (t = {
                ...
                selectHelper: !0,
                editable: !1,
                events: [{"id":1,"title":"Natus tempore et ei","start":"2021-12-27","end":"2021-12-27","backgroundColor":"#FFAB00","borderColor":"#fff","textColor":"white","url":"http:\/\/localhost\/product\/rajodiya\/erpgo\/main\/erpgo_saas\/main_file\/event\/1\/edit"}],
                dayClick: function (e) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/zoom-meeting/calender.blade.php ENDPATH**/ ?>