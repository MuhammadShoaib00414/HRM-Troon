                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Attachments')); ?></th>
                            ...
                            <tr>
                                    ...
                                    <td>
                                    <?php if($opdPayment['attachment']): ?>
                                   <a href="<?php echo e('/public/uploads/opdFile/'.$opdPayment['attachment']); ?>"  download=""><i class="fa fa-download"> </i></a>       </td>
                                    <?php else: ?>
                                       <i>empty</i>
                                     <?php endif; ?>
                                    <td>
                                    <?php if(!request('type') == 'yearly'): ?> 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/opdPayment/limitset.blade.php ENDPATH**/ ?>