...
<?php $__env->startSection('action-button'); ?>
    <div class="row d-flex justify-content-end">
        <div class="col-xl-4 col-lg-2">
            <?php echo e(Form::open(array('url' => array('employee-tax'),'method'=>'get','id'=>'report_leave'))); ?>
                ...
                <div class="card-body">
                    <div class="table-responsive py-4">
                        <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $emplTaxs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emplTax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e(\Auth::user()->employeeIdFormat($emplTax['employee_id'])); ?></td>
                                    <td><?php echo e($emplTax['name']); ?></td>
                                    <td><?php echo e($emplTax['tax_amount']); ?></td>
                                    <td><?php echo e(\Auth::user()->dateFormat($emplTax['date'])); ?></td>
                                    <td>
                                      <a href="<?php echo e(route('employee.tax.details',$emplTax['employee_id'])); ?>" data-size="lg" data-ajax-popup="true" data-title="View Employee Tax" class="edit-icon" data-toggle="tooltip" data-original-title="Edit"><i class="fas fa-eye"></i></a>
                                    </td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/empTax/index.blade.php ENDPATH**/ ?>