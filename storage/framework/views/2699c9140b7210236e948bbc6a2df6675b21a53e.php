...
<head>
    ...
    <title><?php echo e((Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'Troon HRM')); ?> - <?php echo $__env->yieldContent('page-title'); ?></title>
    <link rel="icon" href="<?php echo e($logo.'/'.(isset($company_favicon) && !empty($company_favicon)?$company_favicon:'2_favicon.png')); ?>" type="image" sizes="16x16">
...
<?php /**PATH C:\xampp\htdocs\HRM\resources\views/layouts/auth.blade.php ENDPATH**/ ?>