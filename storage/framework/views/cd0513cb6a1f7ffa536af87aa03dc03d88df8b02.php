        ...
        <div class="col">
            <div class="all-select-box">
                <div class="btn-box">
                    ...
                    <?php echo e(Form::select('type',$types,isset($_GET['type'])?$_GET['type']:'', array('class' => 'form-control select2'))); ?>
            ...
            <?php if($filter['type']!=__('All')): ?>
                <div class="col">
                    <div class="card p-4 mb-4">
                        ...
                        <h5 class="report-text mb-0"><?php echo e($filter['type']); ?></h5>
                    </div>
                </div>
            <?php endif; ?>
            <div class="col">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/report/statement_report.blade.php ENDPATH**/ ?>