...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Employee EOBI Status')); ?>
...
<?php $__env->startSection('action-button'); ?>
    <div class="row d-flex justify-content-end">
        <div class="col-xl-5 col-lg-2">
            <?php echo e(Form::open(array('url' => array('employee-eobi-status',request()->route('id')),'method'=>'get','id'=>'report_leave'))); ?>
        ...
        <div class="col-auto my-custom">
            ...
            <a href="<?php echo e(url('employee-eobi-status',request()->route('id'))); ?>" class="reset-btn" data-toggle="tooltip"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $employee_eobis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eobi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <tr>
                                    <td><?php echo e(\Auth::user()->employeeIdFormat($eobi['id'])); ?></td>
                                    <td><?php echo e($eobi['name']); ?></td>
                                    <td><?php echo e(!empty($eobi['employee_amount']) ? \Auth::user()->priceFormat($eobi['employee_amount']) : '-'); ?></td>
                                    <td><?php echo e(!empty($eobi['employer_amount']) ? \Auth::user()->priceFormat($eobi['employer_amount']) : '-'); ?></td>

                                    <td><?php echo e(\Auth::user()->dateFormat($eobi['date'])); ?></td>
                                    <td><?php echo e(!empty($eobi['total_employee']) ? \Auth::user()->priceFormat($eobi['total_employee']) : '-'); ?></td>
                                    <td>
                                        <a href=" <?php echo e(url('employee-eobi-status',$eobi['id'])); ?>" data-size="lg"
                                           data-ajax-popup="true" data-title="Edit Allowance" class="edit-icon"
                        ...
                        <br>
                            <?php if($grandTotal): ?>
                                ...
                                <tr>
                                    ...
                                    <td> <strong> <?php echo e($grandTotalEmployer); ?></strong></td>
                                    <td></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/employee-eobi/employee-eobi_status.blade.php ENDPATH**/ ?>