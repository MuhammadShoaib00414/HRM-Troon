    ...
    <tr>
        ...
        <th colspan="2">
            <div class="timelogged">
                ...
                <p><?php echo e($calculatedtotaltaskdatetime . __(' Hours')); ?></p>
            </div>
        </th>
    </tr>
    <tr>
            ...
            <?php $__currentLoopData = $timesheetArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $timesheet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="">
                    ...
                    <?php $__currentLoopData = $timesheet['dateArray']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $datetime): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td><span class="task-time" data-type="<?php echo e($datetime['type']); ?>" data-task-id="<?php echo e($timesheet['task_id']); ?>" data-date="<?php echo e($datetime['date']); ?>" data-ajax-timesheet-popup="true" data-url="<?php echo e($datetime['url']); ?>"><?php echo e($datetime['time'] != '00:00' ? $datetime['time'] : '-'); ?></span></td>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\HRM\resources\views/projects/timesheets/week.blade.php ENDPATH**/ ?>