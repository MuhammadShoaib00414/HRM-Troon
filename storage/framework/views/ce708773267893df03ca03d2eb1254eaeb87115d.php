...
<?php $__env->startSection('action-button'); ?>
    <div class="row d-flex justify-content-end">
        <div class="col-xl-4 col-lg-2">
            <?php echo e(Form::open(array('url' => array('opd-payment'),'method'=>'get','id'=>'report_leave'))); ?>
        ...
        <div class="col-auto my-custom">
            ...
            <a href="<?php echo e(url('opd-payment')); ?>" class="reset-btn" data-toggle="tooltip" data-original-title="<?php echo e(__('Reset')); ?>">
                <span class="btn-inner--icon"><i class="fas fa-trash-restore-alt"></i></span>
            </a>

            <a href="#" data-url="<?php echo e(route('opd-payment.create')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto"
               data-ajax-popup="true" data-title="<?php echo e(__('Create OPD Payment')); ?>">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <span class="h3 font-weight-bold mb-0 "> <?php echo e($set_total_opd); ?></span> <br>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <span class="h3 font-weight-bold mb-0 "><?php echo e($grandTotal); ?></span>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <span class="h3 font-weight-bold mb-0 "> <?php echo e($set_total_opd - $grandTotal); ?></span>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $opdpaymentss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opdPayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        
                            <tr>

                                    <td><?php echo e(\Auth::user()->employeeIdFormat($opdPayment['employee_id'])); ?></td>
                                    <td><?php echo e($opdPayment['name']); ?></td>
                                
                                    <td><?php echo e(!empty($opdPayment['amount']) ? \Auth::user()->priceFormat($opdPayment['amount']) : '-'); ?></td>
                                  
                                    <td><?php echo e(\Auth::user()->dateFormat($opdPayment['date'])); ?></td>
                                    <td>
                                  
                                    <a href="<?php echo e(url('opd-payment-details',$opdPayment['employee_id'])); ?>" data-size="lg" data-ajax-popup="true" data-title="Edit Allowance" class="edit-icon" data-toggle="tooltip" data-original-title="View"><i class="fas fa-eye"></i></a>        
                                  
                                    <a href="#" class="delete-icon" data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>" 
                                      data-confirm="<?php echo e(__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')); ?>"
                                       data-confirm-yes="document.getElementById('delete-form-<?php echo e($opdPayment['id']); ?>').submit();"><i class="fas fa-trash"></i></a>
                                      <?php echo Form::open(['method' => 'DELETE', 'route' => ['opd-payment.destroy', $opdPayment['id']],'id'=>'delete-form-'.$opdPayment['id']]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/opdPayment/index.blade.php ENDPATH**/ ?>