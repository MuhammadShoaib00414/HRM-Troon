...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('OPD Payment Status Details')); ?>
                ...
                <div class="card-body">
                    <div class="table-responsive py-4">
                        <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <?php
                            ?>
                            <?php $__currentLoopData = $opd_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opd_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><strong><?php echo e($opd_data['month_name']); ?></strong></td>
                                    <td><?php echo e($opd_data['name']); ?></td>
                                    <td><?php echo e($opd_data['amount']); ?></td>
                                    <td><?php echo e(\Auth::user()->dateFormat($opd_data['date'])); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRM\resources\views/opdPayment/opd_payment_status_details.blade.php ENDPATH**/ ?>