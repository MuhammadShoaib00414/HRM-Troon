...
Route::resource('provident', 'ProvidentController')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('provident/create/{eid}', 'ProvidentController@providentCreate')->name('provident.create')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::resource('eobi', 'EOBIController')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('eobi/create/{eid}', 'EOBIController@eobiCreate')->name('eobi.create')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::resource('tax', 'TaxDeductionController')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('tax/create/{eid}', 'TaxDeductionController@taxCreate')->name('tax.create')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::POST('payslip/allemployee', 'PaySlipController@getAllEmployee')->name('payslip.allemployee')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('payslip/pdfGenerate', 'PaySlipController@multiplePdfGenerate')->name('payslip.pdfGenerate')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('payslip-list', 'PaySlipController@payslipList')->name('payslip.list')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('payslips/search_json_list', 'PaySlipController@search_json_list')->name('payslips.search_json_list')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::resource('request-provident', 'ProvidentFundController')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::delete('request-provident/{id}/destroy', 'ProvidentFundController@destroy')->name('request-provident.destroy')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('report-provident-fund', 'ProvidentFundController@providentfund')->name('report.provident.fund')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('report-provident-fund/{id}', 'ProvidentFundController@providentfunddetails')->name('report.provident.fund')->middleware(
    [
        'auth',
        'XSS',
    ]
...
// Employee EOBI
Route::resource('employee-eobi', 'EmployeeEOBIController')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('employee-eobi-status', 'EmployeeEOBIController@EobiStatus')->name('employee.eobi.status')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('employee-eobi-status/{id}', 'EmployeeEOBIController@EobiStatusDetails')->name('employee.eobi.status')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::resource('opd-payment', 'OPDController')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::delete('opd-payment/{id}/destroy', 'OPDController@destroy')->name('opd-payment.destroy')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('opd-payment-status', 'OPDController@opdStatus')->name('opd.payment.status')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('opd-payment-status/{id}', 'OPDController@opdStatusDetails')->name('opd.payment.status')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('opd-payment-details/{id}', 'OPDController@opdpaymentDetails')->name('opd.payment.details')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('allocated-amount', 'OPDController@AllocatedAmount')->name('allocated.amount')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('create-allocated-amount', 'OPDController@createAllocatedAmount')->name('create.allocated.amount')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::POST('storeAllocatedAmount', 'OPDController@storeAllocatedAmount')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::delete('allocated-amount/destroyAllocatedAmount/{id}', 'OPDController@destroyAllocatedAmount')->name('allocated-amount.destroyAllocatedAmount')->middleware(
    [
        'auth',
        'XSS',
    ]
...
// emp tax
Route::resource('employee-tax', 'EmpTaxController')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('employee-tax-details/{id}', 'EmpTaxController@show')->name('employee.tax.details')->middleware(
    [
        'auth',
        'XSS',
    ]
);
// Route::get('request-provident-found', 'ProvidentFundController@index')->name('request.provident.found')->middleware(
//     [
//         'auth',
//         'XSS',
//     ]
...
Route::post('attendanceemployee/addAttandanceFromMachine', 'AttendanceEmployeeController@addAttandanceFromMachine')->name('attendanceemployee.addAttandanceFromMachine')->middleware(
    [
        'auth',
        'XSS',
    ]
