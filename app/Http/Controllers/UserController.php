...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // dd($request->name);
        // setUser(99, '106', 'Alex', '', ZK\Util::LEVEL_USER);
        ...
        //     $i = 1;
        //     $getUser = $zk->getUser();
        //     $get_last_uid=end($getUser);
        //     $get_last_uid_add = $get_last_uid['uid'] + $i;
        //    $get_last_ID = (array_key_last ($getUser)+ $i);
        //    $roles = Role::where('id','=',$request->role)->first('name');
        // //    $inseruser= $zk->setUser(1, '106', 'User1', '', ZK\Util::LEVEL_USER);
        //   $inseruser = $zk->setUser($get_last_uid_add, $get_last_ID , $request->name, $roles['name']);
        // }
...
//            $images->move(base_path('uploads/avatar/', $fileNameToStore));

            $image = $request->file('profile');
            $path =  $image->move(public_path('/uploads/avatar'),$fileNameToStore);
        }
