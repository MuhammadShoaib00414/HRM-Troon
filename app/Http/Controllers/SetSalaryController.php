...
class SetSalaryController extends Controller
{
    ...
    public function show($id)
    {
        ...
        else
        {
            ...
            return view('setsalary.employee_salary', compact('taxdeduction','eobis','employee', 'payslip_type', 'allowance_options', 'commissions', 'loan_options', 'overtimes', 'otherpayments', 'saturationdeductions', 'loans', 'deduction_options', 'allowances','providents'));
        }
